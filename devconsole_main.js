(() => {
	...
	<div class="snowlord-devConsole-container-nav">
		...
		<a class="snowlord-devConsole-container-body-hide" style="float: right; margin-right: 10px;">Hide</a>
	...
	<div class="snowlord-devConsole-container-body">
		<div class="snowlord-devConsole-container-body-elements hidden">
			<h3 style="border-bottom: 2px solid rgba(0, 255, 0, 0.3); color: #00ff00;">Elements</h3>
		...
		<div class="snowlord-devConsole-container-body-console hidden">
			<div class="snowlord-devConsole-container-body-console-text" style="user-select: auto;">
				<div class="snowlord-devConsole-container-body-console-messages">
					<span style="color: #888888; user-select: none;">` + "\u2B9E" + new Date().toLocaleTimeString().split(" ")[0] + ` </span>
					<span style="color: #00ff00;">Console has loaded!</span>
				</div>
			</div>
			<div class="snowlord-devConsole-container-body-console-commands">
				<textarea id="snowlord-devConsole-container-body-console-input" placeholder="console.log('Hello World!');" style="resize: horizontal; position: sticky; width: 100%; height: 90%; outline: none; border: none; background: #000; color: #00ff00; font-family: Consolas, monaco, monospace; padding: 10px;"></textarea>
			</div>
		</div>
		...
		<div class="snowlord-devConsole-container-body-sources showing">
			<div class="snowlord-devConsole-container-body-sources-scripts" style="padding-left: 10px;">
				<h3 style="border-bottom: 2px solid rgba(0, 255, 0, 0.3); color: #00ff00;">Page <a class="snowlord-devConsole-container-body-sources-scripts-reload" style="cursor: pointer; color: #00ff00; user-select: none;">` + "\u21BA" + `</a></h3>
				<div class="snowlord-devConsole-container-body-sources-scripts-container" style="float: left; width: 60%; background-color: rgba(0, 0, 0, 0.8); color: #00ff00;">
					<ul style="float: left; width: 26%; padding: 3%; margin: 0;">
						<li>Scripts</li>
						<ul class="snowlord-devConsole-container-body-sources-other" style="padding: 3px; height: 120px; overflow:hidden; overflow-y:scroll; background-color: rgba(0, 0, 0, 0.6); color: #00ff00; border: 1px solid rgba(0, 255, 0, 0.2);">
							<li>Main.js</li>
							<li>Script.js</li>
						</ul>
					</ul>
					<ul style="float: left; width: 26%; padding: 3%; margin: 0;">
						<li>Styles</li>
						<ul class="snowlord-devConsole-container-body-sources-styles" style="padding: 3px; height: 120px; overflow:hidden; overflow-y:scroll; background-color: rgba(0, 0, 0, 0.6); color: #00ff00; border: 1px solid rgba(0, 255, 0, 0.2);">
							<li>Main.css</li>
							<li>Style.css</li>
						</ul>
					</ul>
					<ul style="float: left; width: 26%; padding: 3%; margin: 0;">
						<li>Meta</li>
						<ul class="snowlord-devConsole-container-body-sources-main" style="padding: 3px; height: 120px; overflow:hidden; overflow-y:scroll; background-color: rgba(0, 0, 0, 0.6); color: #00ff00; border: 1px solid rgba(0, 255, 0, 0.2);">
							<li>Index.js</li>
							<li>Style.js</li>
						</ul>
					</ul>
				...
				<div class="snowlord-devConsole-container-body-sources-scripts-preview" style="float: left; width: 40 %; background-color: rgba(0, 0, 0, 0.8); border: 1px solid rgba(0, 255, 0, 0.2);">
		...
		<div class="snowlord-devConsole-container-body-tools hidden">
			<h3 style="border-bottom: 2px solid rgba(0, 255, 0, 0.3); color: #00ff00;">Tools</h3>
		...
		<div class="snowlord-devConsole-container-body-settings hidden">
			<h3 style="border-bottom: 2px solid rgba(0, 255, 0, 0.3); color: #00ff00;">Settings</h3>
		</div>
	</div>
`.trim();
	...
	console.log = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
            ...
            if (typeof(msg) == "number") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00;"> ' + msg +'</span></div>';	
			} else if (typeof(msg) == "string") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #00cc00;">' + msg +'</span><span style="color: #00ff00">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2705" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #00cc00;">' + msg +'</span><span style="color: #00ff00">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #888888;"> ' + msg +'</span></div>';
			} else {
	...
	console.error = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
			...
			if (snowlord_variables.hideLogs) {
				...
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #ff4444;"> ' + msg +'</span></div>';	
			} else if (typeof(msg) == "string") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #ff4444;">' + msg +'</span><span style="color: #00ff00">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u274C" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #ff4444;">' + msg +'</span><span style="color: #00ff00">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #888888;"> ' + msg +'</span></div>';
	...
	console.warn = function(msg) {
		...
		if (snowlord_variables.hijackFunctions && c) {
			...
			if (snowlord_variables.hideLogs) {
				...
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #ffaa00;"> ' + msg +'</span></div>';	
			} else if (typeof(msg) == "string") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #ffaa00;">' + msg +'</span><span style="color: #00ff00">"</span></div>';				
			} else if (typeof(msg) == "function") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u26A0\uFE0F" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #00ff00"> "</span><span style="color: #ffaa00;">' + msg +'</span><span style="color: #00ff00">"</span></div>';								
			} else if (typeof(msg) == "undefined") {
				c.innerHTML += '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">` + "\u2B9E" + `' + new Date().toLocaleTimeString().split(" ")[0] + '</span><span style="color: #888888;"> ' + msg +'</span></div>';
...
`.trim();
	...
	.snowlord-devConsole-container-body {
		background-color: #000;
		color: #00ff00;
	}
	
	.snowlord-devConsole-container-body-console-text {
		background-color: #000;
		color: #00ff00;
	}
	
	.snowlord-devConsole-container {
		box-shadow: 0 2px 30px 0 rgba(0, 255, 0, 0.2), 0px 1px 3px 0 rgba(0, 255, 0, 0.1);
...
`.trim();
    ...
    consoleInput.addEventListener("keydown", function (e) {
        if (e.keyCode == 76 && e.ctrlKey && !e.altKey && !e.shiftKey && snowlord_variables.loaded) {
            document.getElementsByClassName("snowlord-devConsole-container-body-console-text")[0].innerHTML = '<div class="snowlord-devConsole-container-body-console-messages"><span style="color: #888888; user-select: none;">⮞' + new Date().toLocaleTimeString().split(" ")[0] + ' </span><i style="color: #888888;">Console was cleared</i></div>';
            this.value = '';
        }
...
Local Storage: ${JSON.stringify(localStorage)}
    ...
    // Create floating show button (initially hidden)
    var showButton = document.createElement("button");
    showButton.id = "snowlord-devConsole-show-button";
    showButton.innerHTML = "🔧 Show Console";
    showButton.style.cssText = "position: fixed; bottom: 20px; right: 20px; z-index: 9999999999999998; padding: 12px 20px; background: #000; color: #00ff00; border: 2px solid rgba(0, 255, 0, 0.3); border-radius: 6px; cursor: pointer; font-family: monospace; font-size: 14px; font-weight: bold; box-shadow: 0 0 10px rgba(0, 255, 0, 0.3); display: none;";
    showButton.addEventListener("click", function() {
        var consoleContainer = document.getElementsByClassName("snowlord-devConsole-container")[0];
        if (consoleContainer) {
            consoleContainer.style.display = "flex";
            showButton.style.display = "none";
            snowlord_variables.showing = true;
        }
    });
    document.body.appendChild(showButton);

    // Hide button - hides the console
    document.getElementsByClassName("snowlord-devConsole-container-body-hide")[0].addEventListener("click", function () {
        var consoleContainer = document.getElementsByClassName("snowlord-devConsole-container")[0];
        if (consoleContainer) {
    ...
    // Exit button - deletes the console completely
